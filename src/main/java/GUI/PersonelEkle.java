 ...
 * @author Lenovo
 */
public class PersonelEkle implements IGui{
   JFrame window;
    JButton b1;
    ...
    JTextField textuser, textpassword,textuser1,textuser2,textuser3;
        ...
        window.setVisible(true);
            ...
            personel personel=new personel();
                personel.setIsim(textuser.getText());
                personel.setYetki_isim(textuser3.getText());
                personel.setTC(textuser1.getText());
                personel.setTelefon(textuser2.getText());
                personel.setSifre(Integer.parseInt(textpassword.getText()));
               new personel_controller(personel);               
            }
        });
